...
class RDPController extends Controller
{
    ...
    {
        $rdp_types = Category::find(4)->subCategories;
        $title = "All Premium RDP";
        return view('admin.rdps')->with(['rdp_types'=>$rdp_types, 'title'=>$title]);
    }
    ...
    {
        $sub_categoires = SubCategory::where('category_id', 4)->get();
