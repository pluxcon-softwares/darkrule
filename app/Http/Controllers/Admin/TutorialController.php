...
class TutorialController extends Controller
{
    ...
    {
        $tutorial_types = Category::find(3)->subCategories;
        $title = "All Tutorials";
        return view('admin.tutorials')->with(['tutorial_types'=>$tutorial_types, 'title'=>$title]);
    }
    ...
    {
        $sub_categoires = SubCategory::where('category_id', 3)->get();
